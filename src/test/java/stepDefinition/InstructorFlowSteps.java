...
public class InstructorFlowSteps extends Base {
    ...
    public void user_navigates_to_udemy_website() {
        func.openURL(driver, "https://www.udemy.com/");
    }
    ...
    public void search_results_should_be_displayed() {
        Assert.assertTrue(func.getCurrentURL(driver).contains("q="), "❌ Search results not displayed.");
    }

    @When("User selects the first course from results")
    public void user_selects_first_course() {
        Pages.search.openFirstCourse();
    }
    ...
    public void course_added_successfully() {
        Assert.assertTrue(func.getCurrentURL(driver).contains("/course/"), "❌ Not on Course Detail page.");
    }
    ...
    public void verify_invalid_search_message() throws IOException {
        ...
        String path = func.captureScreenshot(driver, "Invalid_Search_Result");
